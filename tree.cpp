...
// Destructor to clean the object
Tree::~Tree()
{
    delete[] tab;
}
...
string Tree::exportTree()
{
    ...
    cout << "Name of the Christmas card: ";
    cin >> card;
    card += ".txt";
    cout << "Click [ENTER] to export the file" << endl;
    getchar();
    getchar();
...
void Tree::displayMenu()
{
    cout << endl
         << endl
         << "[1] -> Decorate the tree with star" << endl;
    cout << "[2] -> Decorate the tree with chains" << endl;
    cout << "[3] -> Creat a snowman under the tree" << endl;
